...
import ReactDOM from "react-dom/client";
      ...
      /*
            ...
            - search Bar
            - Restaurant list
            - Restaurnat card(lot of restaurant card)
                    - Image
                    - Name
                    - Ratting
                    - Cusines
...
const Title = () =>(
    <img alt="logo" className="logo" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQYPUqRfxIuiPb2p7xVnVTy2FZxqpuCCD9B5Q&usqp=CAU" />
);  
...
// what we pass in selecttor in angular term from parent to child we call that props
// passing properties into my component
const Body = ()=>{
    return <div className="restaurant-list">
      {
        restrautList.map((restraut)=>{
          return <RestaurantCard {...restraut.data} />
        })
      }
